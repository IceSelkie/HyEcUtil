 ...
 * class Point3I
 * <p>
 * A three dimensional point of integers to represent a location in space.
 *
 * @author Selkie
 * @version 1.1
 */
public class Point3I implements Serializable, Cloneable
{
  ...
  public Point3D toPoint3D() {return new Point3D(x,y,z);}
  public Point3D d() {return toPoint3D();}
   ...
   * <code>Point3I</code> are equal if the values of their
   * <code>x</code>, <code>y</code>, and <code>z</code> member fields,
   * representing their position in the coordinate space, are the same.
   *
   * @param obj an object to be compared with this <code>Point3I</code>
   * @return <code>true</code> if the object to be compared is
   * an instance of <code>Point3I</code> and has
